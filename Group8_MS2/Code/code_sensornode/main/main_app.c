...
void app_main(void)
{
	...
	//Check API for latest prediction
	xTaskCreate(checkAPIForLatestPrediction, "FetchOnlinePrediction", 16384, NULL, 10, NULL);
	...
	else
	{
		...
		xTaskCreate(publishCountEverySecond, "PublishCountSeconds", 4096, NULL, 10, NULL);
	}
